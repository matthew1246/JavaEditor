...
public class AllVersionsJarNoPackage extends AllVersionsJar {
	...
	public void MakeJarUsingmsdos(int javaversionnumber,String main_class) {
		try {
			...
			String input = "\""+System.getProperty("java.home")+"\\bin\\jar.exe\" cfm "+file.getAbsolutePath()+"\\ForJava"+javaversionnumber+"_"+main_class2+".jar mf.txt .";
			if(javaversionnumber == 23 || javaversionnumber == -2) {
				input = "\""+System.getProperty("java.home")+"\\bin\\jar.exe\" cfm "+file.getAbsolutePath()+"\\"+main_class2+".jar mf.txt .";
			}
	...
	public Powershell getPowershell(Main main,String main_class,String dir,AllFiles allfiles,boolean _isMoreThanOneJar) {
		return new PowershellNoPackage(main,main_class,dir,allfiles,_isMoreThanOneJar);
	}
}