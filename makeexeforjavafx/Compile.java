...
public class Compile {
	...
	public void compileall(String fileName,SaveActionListener sal,ActionEvent ev,boolean withJavaFX,Main main,boolean makejar) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
	...
	public void compileall(String fileName,int javaversionnumber,SaveActionListener sal,ActionEvent ev,boolean withJavaFX,Main main,boolean makejar) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
	...
	public void compileall(String fileName,int javaversionnumber,SaveActionListener sal,ActionEvent ev,boolean withJavaFX,Main main,boolean makejar,boolean hasJarsFolder) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
			...
			Packager packager = new Packager(main);
			if(withJavaFX) {
				ExtractJavaFXJars extractjavafxjars = new ExtractJavaFXJars(main,hasJarsFolder);
				commandline.addJavaFX();						
			}
			commandline.compileAll();
	...
	public void compileallbutton(String fileName,SaveActionListener sal,ActionEvent ev,boolean withJavaFX,Main main) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
	...
	public void compileallbuttonwitherrors(String fileName,SaveActionListener sal,ActionEvent ev,boolean withJavaFX,Main main) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
			...
			if(line == null) {
				...
				CompileErrors compileerrors=new CompileErrors(main,lines);
			}
		} catch (IOException ex) {
			ex.printStackTrace();
		}		
