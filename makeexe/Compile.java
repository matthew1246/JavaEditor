...
public class Compile {
	...
	public void compileallbutton(Main main,String fileName,SaveActionListener sal,ActionEvent ev) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
	...
	public void compileallbuttonwitherrors(Main main,String fileName,SaveActionListener sal,ActionEvent ev) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
