...
public class PowershellOnePackage implements Powershell {
	...
	public void makeJar(int javaversionnumber) {
		try {
			...
			JOptionPane.showMessageDialog(null,"jar output directory is:"+createJarFolderLocation);
			if(!packager.containsPackage() || !packager.isInRightFolders()) {
				...
				if(javaversionnumber != 23 && javaversionnumber != -2) {
					...
					output2.write("\n");
					output2.write("\""+System.getProperty("java.home")+"\\bin\\java.exe\" -jar "+createJarFolderLocation+main_class2+".jar");
				}
			}						
			output2.write("\n");
			// output2.close();
