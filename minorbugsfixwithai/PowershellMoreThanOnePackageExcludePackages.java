...
** The user excluded some folders from packager.classpath.
** The folders that were not excluded are added to the jar with jar.exe -C folder .
*/
public class PowershellMoreThanOnePackageExcludePackages extends PowershellMoreThanOnePackage {
	...
	public PowershellMoreThanOnePackageExcludePackages(Main main,String main_class,String dir,AllFiles allfiles,boolean _isMoreThanOneJar,List<String> includedFolders) {
