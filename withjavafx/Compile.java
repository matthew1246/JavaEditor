...
public class Compile {
	...
	public void compileall(String fileName,int javaversionnumber,SaveActionListener sal,ActionEvent ev,boolean withJavaFX,Main main,boolean makejar,boolean jarsFolder) {
		try {
			sal.actionPerformed(ev);
			if(fileName.equals(""))
				fileName = main.fileName;
			...
			Packager packager = new Packager(main);
			if(withJavaFX) {
				ExtractJavaFXJars extractjavafxjars = new ExtractJavaFXJars(main,jarsFolder);
				commandline.addJavaFX();						
			}
			commandline.compileAll();
